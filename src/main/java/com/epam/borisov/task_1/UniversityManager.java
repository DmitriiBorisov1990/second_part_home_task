...
public class UniversityManager {
    ...
    public static void main(String[] args) {
        ...
        Student student_1 = new Student(711, "Dmitrii", "Borisov");
        Student student_2 = new Student(711, "Dmitrii", "Shevelev");
        Student student_3 = new Student(712, "Ilia", "Kuznetsov");
        Student student_4 = new Student(712, "Viktor", "Virkovskii");
        Student student_5 = new Student(511, "Sergei", "Semenuk");
        Student student_6 = new Student(511, "Dmitrii", "Nosachev");
        Student student_7 = new Student(512, "Kirill", "Sokolovskii");
        Student student_8 = new Student(512, "Aleksandr", "Turonok");
    ...
    private static void addMark(Student student, String subjectName, int... marks) {
